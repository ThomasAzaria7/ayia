(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-carousels', ['exports', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['ngx-carousels'] = {}),global.ng.common,global.rxjs,global.rxjs.operators,global.ng.core));
    ...
    var CarouselComponent = /** @class */ (function () {
        ...
        CarouselComponent.prototype.setupCarousel =
            ...
            function () {
                ...
                if (this.autochange)
                    this._subscriber = rxjs.interval(this.period)
                        .subscribe(function () {
                ...
                switch (this.animationType) {
                    case 'fade':
                        if (item) {
                            ...
                            rxjs.interval(1005).pipe(operators.first())
                                .subscribe(function () {
        ...
        CarouselComponent.propDecorators = {
            carouselInners: [{ type: core.ContentChildren, args: [CarouselItemDirective,] }],
            carouselItems: [{ type: core.ViewChildren, args: ['carouselItems',] }],
            autochange: [{ type: core.Input }],
    ...
    ***************************************************************************** */
    ...
    var RotateCarouselItemDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        RotateCarouselItemDirective.ctorParameters = function () {
            return [
                { type: core.TemplateRef }
            ];
        };
    ...
    var RotateCarouselComponent = /** @class */ (function () {
        function RotateCarouselComponent() {
             ...
             */
            this.rotationStart = new core.EventEmitter();
            /**
             * Emit event of rotation end
             */
            this.rotationEnd = new core.EventEmitter();
            /**
        ...
        RotateCarouselComponent.prototype.setRotationTimer =
            ...
            function () {
                var _this = this;
                return rxjs.timer(0, this._period)
        ...
        RotateCarouselComponent.propDecorators = {
            rotateItems: [{ type: core.ContentChildren, args: [RotateCarouselItemDirective,] }],
            carouselInner: [{ type: core.ViewChild, args: ['carouselInner',] }],
            rotationStart: [{ type: core.Output }],
            rotationEnd: [{ type: core.Output }],
    ...
    var RingCarouselItemDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        RingCarouselItemDirective.ctorParameters = function () {
            return [
                { type: core.TemplateRef }
            ];
        };
    ...
    var RingCarouselComponent = /** @class */ (function () {
        ...
        RingCarouselComponent.prototype.showRings =
            ...
            function (x, y, index) {
                ...
                /** @type {?} */
                var timer = rxjs.interval(this.ringsDelay).pipe(operators.take(this.ringsCount));
                ...
                timer.pipe(operators.last()).subscribe(function (_) {
                    rxjs.interval(_this.ringsDuration).pipe(operators.first())
        ...
        RingCarouselComponent.propDecorators = {
            carouselItems: [{ type: core.ContentChildren, args: [RingCarouselItemDirective,] }],
            carouselRef: [{ type: core.ViewChild, args: ['carousel',] }],
            expandAnimations: [{ type: core.ViewChildren, args: ['expandSvgAnimations',] }],
            collapseAnimations: [{ type: core.ViewChildren, args: ['collapseSvgAnimations',] }],
            transitionStart: [{ type: core.Output }],
            transitionEnd: [{ type: core.Output }],
            ringColor: [{ type: core.Input }],
            ringsCount: [{ type: core.Input }],
            ringsDelay: [{ type: core.Input }],
            ringsDuration: [{ type: core.Input }],
            expandOnTransition: [{ type: core.Input }],
            enableControl: [{ type: core.Input }]
        };
    ...
    exports.RingCarouselComponent = RingCarouselComponent;
    exports.RotateCarouselComponent = RotateCarouselComponent;
    exports.RingCarouselItemDirective = RingCarouselItemDirective;
    exports.RotateCarouselItemDirective = RotateCarouselItemDirective;
    exports.ɵb = CarouselItemDirective;
...
//# sourceMappingURL=ngx-carousels.umd.js.map